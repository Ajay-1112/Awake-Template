                        ...
                        <div className=" relative">
                            <div className="relative mt-8  ">
                                ...
                                <div className="relative grid grid-cols-1 text-center gap-y-8 sm:gap-y-10 md:gap-y-12 md:grid-cols-4 gap-x-8">
                                    {steps.map((step) => (
                                        <div key={step.number}>
                                            <div className="flex items-center justify-center w-16 h-16 mx-auto   border-2 border-gray-300 rounded-full shadow">
                                                <span className="text-xl font-semibold text-[#8E4C32] ">
                                                    {step.number}
                                                </span>
                                            </div>
                                            <h3 className="mt-4 sm:mt-6 text-xl font-semibold leading-tight text-[#2F3119]  md:mt-10">
                                                {step.title}
                                            </h3>
